    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Добавление мебели</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="furniture_type_id" class="form-control">
                                    ...
                                    <option
                                        {{ old('furniture_type_id') == $furnitureType->id ? ' selected' : '' }}
                            ...
                            <div class="form-group">
                                <label>Цвет</label>
                                <input type="text" name="color" value="{{ old('color') }}" class="form-control"  placeholder="Цвет">
                                @error('color')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
